...
def get_args():
    ...
    parser.add_argument('--experiment', dest='experiment', type=str, default='hold_back')  # experiment name
    ...
    parser.add_argument('--end_cond', dest='end_cond_threshold', type=float, default='0.94')  # end condition percentage
